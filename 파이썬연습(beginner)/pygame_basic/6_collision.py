...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\ljs74\\OneDrive\\바탕 화면\\임정석\\PythonWorkspace\\pygame_basic\\enemy.png")
...
while running: 
    ...
    character_x_pos += to_x * dt #프레임이 달라진다고 이동속도가 바뀌면안되기때문에 
    ...
    enemy_rect.top = enemy_y_pos
     ...
     #충돌 체크
    if character_rect.colliderect(enemy_rect): #colliderect 사각형기준으로 충돌이 있었는지확인하는 함수
        print("충돌했어요")
        running = False
